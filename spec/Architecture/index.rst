...
* One class resolver must be registered, which finds Java classes belonging to simple type names. For example, a ``String`` would be resolved to ``java.lang.String``.
