...
public class BinarySubtractionExpression extends BinaryArithmeticExpression {
    ...
    public BinarySubtractionExpression (CompilationContext compilationContext, BrygParser.ExpressionContext leftCtx,
                                           BrygParser.ExpressionContext rightCtx) {
        super (compilationContext, leftCtx, rightCtx);
    }

    public BinarySubtractionExpression (CompilationContext compilationContext, Expression left, Expression right, int line) {
